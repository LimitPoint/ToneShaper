...
class WebViewObservableObject: ObservableObject {
    ...
    deinit {
        print("WebViewObservableObject deinit")
    }
...
struct WebView: View {
    ...
    var urlBar: some View {
        ...
        HStack {
            if let url = URL(string: limitPointURL) {
                Button(action: {
                    webViewModel.navigate(to: url)
                }) {
                    Text("Limit Point LLC")
                }
            ...
            if let url = URL(string: kToneShaperURL) {
                Button(action: {
                    webViewModel.navigate(to: url)
                }) {
                    Text("ToneShaper")
...
struct WebView_Previews: PreviewProvider {
    static var previews: some View {
        WebView(webViewModel: WebViewObservableObject(urlString: "https://www.limit-point.com"))
    }
}
